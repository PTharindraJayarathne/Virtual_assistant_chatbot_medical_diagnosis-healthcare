...
<body>
    ...
    <script>
        ...
        $("#send").on("click",function(e){
            ...
            if ($userMessage == "") {
                $appendBotResponse = '<div id="messagesContainer"><div class="chat botMessages">'
                +"Sorry can't process empty inputs! Try again!"+'</div></div>';
                ...
                $.ajax({
                    ...
                    success: function(data){
                        // show response
                        $appendBotResponse = '<div id="messagesContainer">'+
                        '<div class="chat botMessages">'+data+'</div></div>';
                        $("#messageDisplaySection").append($appendBotResponse);
                    }
                });
            }
